# Generated by Django 2.2.5 on 2020-05-17 12:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='逻辑删除')),
                ('hbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mysqltest.BookInfo', verbose_name='英雄属于的图书')),
            ],
            options={
                'db_table': 'tb_heros',
            },
